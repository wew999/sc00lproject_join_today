...
const roomList = ref([{name: 'Город',
  ...
  {name: 'Заражение', //21
    ...
    msgtext: 'В вас попадает дротик! Похоже, комната была ловушкой! Вы чувствуете себя нехорошо...'
  },
  {name: 'Фонтан', //22
    btn1: 'Испить', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: cure, fun2: goTown, fun3: '', fun4: '',
    msgtext: 'Вы натыкаетесь на целебный источник. Он выглядит так свежо, что вам кажется что более чистой воды вы не видели никогда. Будете ли вы пить из оазиса?'
  },
  {name: 'Стройка', //23
    btn1: 'Построить комнату (500)', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: construction, fun2: goTown, fun3: '', fun4: '',
    msgtext: 'Вы натыкаетесь на странный пульт. Видимо, он предлагает постоить новую комнату на фундаменте старой. Хотите попробовать? '
  },
  {name: 'Налог!', //24
  ...
  {name: 'Телепорт', //25
    ...
    msgtext: 'Похоже, вы наткнулись на метро. Но куда же оно ведёт? Тут нет ни рельс, ни тоннеля, однако поезд всё же приведёт вас куда-то. Но куда? Решать вам.'
  },
    ////
  {name: 'Сомелье', //26
  ...
  {name: 'Тренажерный зал', //30
    ...
    msgtext: 'Здесь можно потренироваться чтобы стать сильнее, но абонемент стоит слишком дорого.'
  },
  {name: 'ХАОС, ХАОС!', //31
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: goJevilTown, fun2: '', fun3: '', fun4: '',
    msgtext: 'ХАОС, ХАОС! ВСЕ КОМНАТЫ ПЕРЕМЕШАЛИСЬ! КТО ВРАЩАЕТ ЭТОТ МИР?'
  },
  {name: 'Эхо-камера', //32
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: goEchoTown, fun2: '', fun3: '', fun4: '',
    msgtext: 'Вы попадаете в комнату, в которой настолько тихо, что вы можете слышать своё сердцебиение. Вам кажется что всё в ней стало глубже, все эффекты что у вас есть и все эффекты что у вас будут. Вы покидаете эхо камеру, но это странное чувство остаётся с вами.'
  },
  {name: 'Черепаха', //33
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: fightTurtle, fun2: '', fun3: '', fun4: '',
    msgtext: 'Вам преграждает путь странное существо с огромным панцирем. Хватит ли у вас сил его пробить?'
  },
  {name: 'Зомби', //34
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: fightZombie, fun2: '', fun3: '', fun4: '',
    msgtext: 'На вас нападает безумный мужчина, чьё тело покрыто язвами и струпьями. Несмотря на хилый вид, кажется он резв как дьявол.'
  },
  {name: 'Пожарный', //35
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: fightFirefighter, fun2: '', fun3: '', fun4: '',
    msgtext: 'На вас нападает мужчина в костюме пожарного и пожарной маске. В его руке зажигательная смесь, вам уже не нравиться, что вы втупили в этот бой.'
  },
  {name: 'Кнопка?', //36
    btn1: 'Нажать', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: destruction, fun2: goTown, fun3: '', fun4: '',
    msgtext: 'В этой комнате на столе лежит странная кнопка. Что будет если её нажать?'
  },
  {name: 'Воровство', //37
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: theft, fun2: '', fun3: '', fun4: '',
    msgtext: 'Посреди комнаты стоит сстранная коробка. Вы с опаской приближаетесь ближе...'
  },
  {name: 'Ловушка', //38
    btn1: 'Уйти', btn2: 'Уйти', btn3: 'N/A', btn4: 'N/A',
    fun1: zemlya, fun2: '', fun3: '', fun4: '',
    msgtext: 'В вас попала стрела прямиклом из ниоткуда! Похоже, в комнате была ловушка! Будьте аккуратнее в следующий раз.'
  },
  {name: 'Выход', //39
